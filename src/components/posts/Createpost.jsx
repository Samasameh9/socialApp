...
import { CreateMyPost } from "../../services/postsApi";
  ...
  return (
    <>
      <form onSubmit={addPost}>
        <div className="editor mx-auto w-sm md:w-lg lg:w-3xl flex flex-col  text-gray-800 border border-gray-300 p-4 shadow-lg max-w-4xl bg-white">
          <h2 className="text-center font-bold text-2xl py-3 text-green-700">
            Post
          </h2>
          <input
            onChange={(e) => {
